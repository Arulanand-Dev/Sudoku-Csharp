...
namespace Sudoku
{
    public class Sudoku
    {
        ...
        public event ClearInputsEventHandler ClearInputs;
        public delegate void ClearInputsEventHandler(int[][] grid);
        public event VerifyInputsChangedEventHandler VerifyInputs;
        public delegate void VerifyInputsChangedEventHandler(int[][] grid);
